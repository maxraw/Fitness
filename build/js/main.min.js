...
},{"./modules/form-validate/form":3,"./modules/slider/slider":9,"./modules/tabs/init-tabs":10,"./modules/video/video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
function initSlider() {
  var createSwiper = function createSwiper(selector, options) {
    return new _swiper.default(selector, options);
  };
